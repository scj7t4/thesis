...
\ac{RED} parameters were selected using Equation \ref{eq:prob-est} and \cite{JOURNALANON}.
...
The number of packets for the $resp$ and $init_m$ were selected from the worst case of the algorithm in \cite{JOURNALANON}.
...
\begin{figure}
\includegraphics[width=\linewidth]{m-max-average-queue.pdf}
