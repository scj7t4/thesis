...
\begin{minipage}{0.45\textwidth}
    ...
    \caption{Time in-group over a 10 minute run for a two process system with a 100ms resend time}
...
\begin{minipage}{0.45\textwidth}
    ...
    \caption{Time in-group over a 10 minute run for a two process system with a 200ms resend time}
...
As packets began to cross the partition (as the omission rate decreases), DGI instances on either side attempted to complete elections with the processes on the opposite partition and the in group time began to decrease.
...
As result, most of the lost in group time came from elections.
...
There was a general increasing trend for the amount of time in-group shown in Figure \ref{fig:IGT-SUC-2NODE-100}.
However, there was a high amount of variance for any particular trial.
...
\begin{minipage}{0.45\textwidth}
    ...
    \caption{Time in group over a 10 minute run for two process system with 100ms resend time}
...
\begin{minipage}{0.45\textwidth}
    ...
    \caption{Time in group over a 10 minute run for two process system with 200ms resend time}
...
With this hardening technique the algorithms can prevent critical failures which could decrease quality of life or endanger that life.
