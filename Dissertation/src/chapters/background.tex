...
Contraints for detecting processing that exhibit Byzantine behavior is a famous result in distributed systems.\cite{byzantine-generals}
...
\ac{ECN} is a techinque for managing congestion in IP networks. 
...
DGI is a real-time system; certain actions (and reactions) involving power system components need to be completed within a prespecified time-frame to keep the system stable.
