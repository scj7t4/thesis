...
% What if the probability is not known? Then its just the regular problem and its boring.

% I want to talk about constructing an HMM for a given hidden global state?
% Later I want to show that there is a special class of HMM where the observations correspond to a markov chain
