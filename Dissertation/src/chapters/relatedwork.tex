...
\subsection{Isis (1989) and Horus (1996)}
...
\section{Markov Models of Distributed Systems}

CITE focus on examining the emergent behavior as a collection of processes in a grid computing scenario work to process a large dataset.
...
\section{Messaging Analysis of Failure Detectors}
...
\section{Congestion in Cyber Physical Systems}
Other, distantly related, work use cyber communication to avoid congestion in the physical network.
