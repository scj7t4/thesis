...
\title{Overview of DGI's Group Management Algorithm}
%
%
...
\thanks{S. Jackson and B. McMillin are with the Department
...
{Shell \MakeLowercase{\textit{et al.}}: Markov Models of Leader Elections in a Smart Grid System}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{sjackson}}]{Stephen Jackson}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bmcmillin}}]{Bruce McMillin}
