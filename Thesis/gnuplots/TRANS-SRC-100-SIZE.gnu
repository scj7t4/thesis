...
set output 'TRANS-SRC-100-SIZE.tex'
set boxwidth 3 absolute
set title "Average Group Size: Transient Partition (SRC - 100ms Resend)" 
...
plot 'TRANS-SRC-100.dat' using 1:14:14:14:14 with candlesticks ls 2 notitle,      ''                  using 1:13:12:16:15 with candlesticks ls 1 notitle
