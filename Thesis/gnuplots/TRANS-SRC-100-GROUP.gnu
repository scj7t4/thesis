...
set output 'TRANS-SRC-100-GROUP.tex'
set boxwidth 3 absolute
set title "Time In Group: Transient Partition (SRC 100ms Resend)" 
...
plot 'TRANS-SRC-100.dat' using 1:9:9:9:9 with candlesticks ls 2 notitle,      ''                 using 1:8:7:11:10 with candlesticks ls 1 notitle
