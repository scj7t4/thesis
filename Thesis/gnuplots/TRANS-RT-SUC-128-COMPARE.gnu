...
set title "Simulated versus Experimental Time In Group: Two Node (SUC 128ms Resend)" 
...
plot 'TRANS-RT-SUC-128.dat'        using 1:3 ti "Experimental Value", \
     'TRANS-RT-SUC-128.dat'  using 1:2 ti "Markov Value"
