...
Totem\cite{TOTEMTOOLKIT} is largely in the same vein as Isis. Developed at the University of
...
Failure detectors \cite{FAILUREDETECTORS} (Sometimes referred to as unreliable failure detectors)
