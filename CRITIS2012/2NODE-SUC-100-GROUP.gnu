...
set output '2NODE-SUC-100-GROUP.png'
set boxwidth 3 absolute
set title "Time In Group: Two Node (SUC 100ms Resend)" 
...
plot '2NODE-SUC-100.dat' using 1:9:9:9:9 with candlesticks ls 2 notitle,      ''                 using 1:8:7:11:10 with candlesticks ls 1 notitle
