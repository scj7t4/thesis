...
However, research such as \cite{HARINI}, indicates that cyber faults can cause a
...
Correlation was calculated from the collected data: a correlation coefficient of 0.7656 was 
found for the 128ms resend case between the experimental median and Markov-predicted value,
 and a factor of .8603 was found for the 64ms resend case between the experimental median and Markov-predicted value.
