...
a predetermined window of execution which it may use to perform it's duties. When
...
process. The leader, using a function will periodically search for
