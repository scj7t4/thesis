...
\begin{figure}
    ...
    \caption{Example DGI schedule. Processes execute the selected module simultaneously.}
    \label{fig:schedule}
\end{figure}
...
Next load balancing runs to manage power resources in the created group.
...
Future work will combine this analysis with ECN techniques to pre-emptively change the behavior of DGI to ensure a good level of service.
