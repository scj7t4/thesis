...
Transient partitions are formed when a faulty link between inside a group of processes causes the group to divide temporarily.
...
However, it is important the configuration leader election supplies is one where the system can do viable work without causing physical faults like voltage collapse or blackouts\cite{HARINI}.
