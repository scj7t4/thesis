...
In a real-time environment, messages that are delayed to miss real-time deadlines will have the same appearance as an omitted message.
...
Since the state of the group is incorrect, it cannot be used in a Markov chain with perfect information, as it does not describe the actual state of the system.
